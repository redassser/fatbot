exports.run = (client,message,array) => {
    ...
    if(array[0]==="setup") { //command .hotel setup
      ...
      message.guild.channels.create("Hotel", {
        ...
        message.guild.channels.create("reception", {
          type: "text",
          topic: "The hotel houses secluded rooms for users and enables them to use our escort with privacy!",
          parent: hotel,
          nsfw: true
        }).then(reception => {
          hotelembed
            ...
            .setImage("https://rule34.xxx/images/header.png")
            ...
            .addField("Our services","We also offer ``.r34 [tags]``, a command you mind find useful in your private room.\nEx: ``.r34 1girls thick_thighs``")
    ...
    helpembed
        ...
        .addField("``.hotel room blacklist [tag]``","Adds the tag to the room's blacklist, or removes it from the room's blacklist")
    ...
    switch(subject) { //switch .hotel
      case "room":
        var blacklist = ["Blacklist=> ","scat","furry"].join("; ")
